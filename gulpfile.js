...
gulp.task('css', function () {
  return gulp.src(paths.app.css.src) // Файл styles.styl
    ...
    .pipe(gulp.dest(paths.app.css.dest)) // Сохранение объединенного файла styles.css в папку app/assets/css
...
gulp.task('js', function() {
  return gulp.src(paths.app.js.src)
    ...
    .pipe(sourcemaps.init()) // Инициализация Source maps
    .pipe(concat('scripts.js')) // Объединение JS-файлов
    .pipe(gulp.dest(paths.app.js.dest)) // Сохранение объединенного файла scripts.js
    .pipe(rename({suffix: '.min'})) // Переименование scripts.js в scripts.min.js
